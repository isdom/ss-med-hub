...
@FeignClient(
        value = "${ESL_PROVIDER:unknown-script}",
...
public interface EslApi {
    ...
    @RequestMapping(value = "${esl.api.search_text:unknown_ai_api}", method = RequestMethod.GET)
    SearchResponse search_text(@RequestParam("text") String text);
